...
const Button = ({ toggleSidebar, colored, sidebarOpen }) => {
  return (
    <motion.div
      ...
      className={`flex flex-row items-center h-full gap-2  md:gap-4  w-fit justify-end xl:gap-8   px-5 py-5 sm:px-8 ${
    ...
    >
      ...
      <motion.span
        layout
        className="z-20 flex flex-col items-end h-full gap-2 text-2xl cursor-pointer  sm:text-3xl"
      >
        <motion.span
