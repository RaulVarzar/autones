...
const Footer = () => {
  ...
  const y = useTransform(contentSpring, [0, 1], ['-10vh', '0vh']);
  const opacity = useTransform(contentSpring, [0.3, 1], ['30%', '100%']);

  return (
    <div
      ref={ref}
      className="w-full px-4 py-4 mx-auto bg-opacity-75 md:px-24 lg:px-48"
    >
      <motion.div
        style={{ scale, y, opacity }}
        className="flex flex-col justify-center gap-6 mb-8 md:flex-row md:gap-24 "
      >
        <div className="">
          <a
            href="/"
        ...
        <div className="space-y-2 text-lg">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Adresa:</p>
            <a
